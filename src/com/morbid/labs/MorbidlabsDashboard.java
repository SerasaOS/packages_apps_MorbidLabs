/*
 * Copyright (C) 2024 Project-Morbid
 *
...
public class MorbidlabsDashboard extends SettingsPreferenceFragment implements View.OnClickListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.morbidlabs_dashboard);

        mPreference = findPreference("morbidlabs_header");
    ...
    public int getMetricsCategory() {
        return MetricsProto.MetricsEvent.MORBID;
    }
